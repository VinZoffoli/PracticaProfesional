const mercadopago = new MercadoPago("APP_USR-a0a8dd17-6ea5-41a4-a176-90a387d117cf", {
...
document.getElementById("carrito-acciones-vaciar").addEventListener("click", vaciarCarrito);
document.getElementById("carrito-acciones-comprar").addEventListener("click", comprarCarrito);
document.getElementById("promo").addEventListener("click", promo);